export default {
  ...
  skills: {
    ...
    items: [
      ...
      },
      {
        id: 'skill-3',
        name: 'Python',
        description: '用于脚本编写、自动化以及快速实验。',
        level: 75
      },
      {
        id: 'skill-4',
        name: 'JAVA',
        description: '用于学习面向对象编程思想并构建基础应用。',
        level: 50
      },
      {
        id: 'skill-5',
      ...
      },
      {
        id: 'skill-7',
        name: 'Unreal Engine',
        description: '用于学习游戏开发、实时渲染与交互系统设计。',
        level: 60
      },
      {
        id: 'skill-8',
        name: 'Algorithms & Data Structures',
        description: '学习核心算法与数据结构，侧重问题求解与逻辑思维。',
        level: 30
      },
      {
        id: 'skill-9',
  ...
  timeline: {
    ...
    },
    {
      ...
      "age": "8岁 / 2018年",
      "event": "开始编程",
      "description": "开始学习 Python"
    },
    {
      "id": "timeline-3",
      "age": "13岁 / 2023年",
      "event": "上线第一个网站",
      "description": "使用 HTML 和 CSS 创建了第一个个人网站"
    },
    {
      "id": "timeline-4",
      "age": "15岁 / 2025年",
      "event": "成立 TATEN",
      "description": "与朋友共同创立 TATEN 编程团队"
    },
    {
      "id": "timeline-5",
      "age": "",
      "event": "未来规划",
      "description": "专注于计算机科学和学业"
    }
    ]
  },
  projects: {
